// loop()에서 led밝기 제어, USS_measure()에서 깜빡임 제거 구현
...
float USS_measure(int TRIG, int ECHO)
{
  ...
  if(reading < dist_min || reading > dist_max) reading = 0.0;// reading = 0 when out of range.
  if(reading == 0) return past_dist;
  return reading;
